...
class MyCustomMessages implements LookupMessages {
  ...
  @override String aboutAMinute(int minutes) => '${minutes} minit lalu';
  @override String minutes(int minutes) => '${minutes} minit lalu';
  @override String aboutAnHour(int minutes) => '${minutes} minit lalu';
...
void snackBarFailed({required BuildContext context, required String content }) =>
    snackBar(context, title: content, backgroundColor: Colors.red, textColor: Colors.white);

void snackBarSuccess({required BuildContext context, required String content }) =>
    snackBar(context, title: content, backgroundColor: Colors.green, textColor: Colors.white);

void toastSuccess({required BuildContext context, required String content }) =>
    toastLong(content, context: context, bgColor: Colors.green, textColor: Colors.white);

void toastFailed({required BuildContext context, required String content }) =>
    toastLong(content, context: context, bgColor: Colors.red, textColor: Colors.white);
