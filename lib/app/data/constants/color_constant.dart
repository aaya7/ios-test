...
class ColorConstant {
  // 0xFF00C53B
  static Color mainColor = const Color(0xFFd9594c);
  ...
  // static Color primaryColor = const Color(0xFF3db49d);
  static const Color primaryColor = const Color(0xff1C852B);
  static const Color primaryBackgroundColor = const Color(0xFFfffcf9);
  static const Color secondaryColor = const Color(0xFFffce1e);
  static const Color thirdColor = const Color(0xFFffce1e);
  static const Color primaryDarkColor = const Color(0xFF0036af);
  static const Color primaryLightColor = const Color(0xffc7e9c9);
  ...
  static const Color viewLineColor = Color(0xFFEAEAEA);
  static const Color errorColor = Color(0xFFFF6347);
